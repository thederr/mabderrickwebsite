      ...
      <div className='container'>
        <div className='row'>
          <div className='col-md-3 col-sm-6'>
            <div className='box'>
              ...
              <p>
                ...
                Amazon Web Services, we build Full Stack Applications that scale
                from 1 to 10 million users
              </p>
            </div>
          </div>
          {/*-*/}
          <div className='col-md-3 col-sm-6'>
            <div className='box'>
              ...
              <p>
                ...
                we make sure your website not only keeps up with the times, but
                it's ready for every sized screen for every sized mobile,
          ...
          <div className='col-md-3 col-sm-6'>
            <div className='box'>
              <div className='circle'>
                <FontAwesomeIcon className="icon" icon={faDraftingCompass} size='2x' />
              </div>
              <h3>AutoCAD Modeling</h3>
              <p>
                Freelance AutoCAD servces are avalible upon request. Here are a
